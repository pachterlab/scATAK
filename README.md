...
-bf --flen=40 [length of biological feature, should be not more than R2 read length, default:40]
...
See demo below for scATAK quant
...
See demo below for scATAK track
